...
export const deHoochBibliography: BibEntry[] = [
	{
		title: "Pieter de Hooch's window shutter with the Habsburg Emperor Charles V (1661)",
		author: 'Elizabeth Den Hartog',
		year: '2022',
		journal: 'Oud Holland',
		url: 'https://www.jstor.org/stable/27311359',
		description:
			'An interesting article regarding the only political foray of de Hooch, the covering up of the Habsburg still being mysterious.'
	},
	{
		title:
	...
	},
	{
		...
		author: 'Anita Jansen et al.',
		year: '2019',
		journal: 'WBooks, Zwolle in cooperation with Museum Prinsenhof Delft',
		url: 'https://hnanews.org/hnar/reviews/pieter-de-hooch-in-delft-from-the-shadow-of-vermeer/',
		description:
			'The best, most up to date research on de Hooch, correcting many long-standing misconceptions about his life and work.'
	},
	{
		title: 'Foregrounding the Background: Images of Dutch and Flemish Household Servants',
	...
	},
	{
		...
		url: 'https://www.jstor.org/stable/40479869',
		description:
			'This article disproved the theory that de Hooch was institutionalised. This complicated discussion surrouning his late works, as the deterioration in his style had previously been attributed to his mental state.'
	},
	{
		title: 'The Age of Rembrandt: Dutch Paintings in the Metropolitan Museum of Art',
	...
	{
		title:
			'A Republic of Educators: Educational Messages in Seventeenth-Century Dutch Genre Painting',
	...
	},
	{
		...
		year: '1998',
		journal:
			'Dulwich Picture Gallery, Wadsworth Atheneum: In association with Yale University Press',
		url: 'https://archive.org/details/pieterdehooch16200sutt',
		description: 'The updated edition of his earlier monograph.'
	},
	{
		title: 'Review: Pieter de Hooch by Peter C. Sutton',
		author: 'E. de Jongh',
		year: '1980',
		journal: 'Simiolus',
	...
	{
		title:
			'[Pieter de Hooge], De groote schouburgh der Nederlantsche konstschilders en schilderessen',
		author: 'Arnold Houbraken',
		year: '1753',
		journal: 'DBNL',
		url: 'https://houbraken-translated.rkdstudies.nl/2-1-59/page-30-39/',
		description:
			'The first real source of information about de Hooch comes from "The Great Theatre of Dutch Painters", where a single pages mentions de Hooch, stating "who was outstanding in the painting of views of room containing companies of gentlemen and damsels."'
	}
];
